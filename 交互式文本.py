...
# 页面配置
st.set_page_config(page_title="文本分析", page_icon="C:/Users/zk123/OneDrive/图片/Saved Pictures/20210412093214996.png", layout="wide")
...
# Streamlit 输入框
url = st.text_input("请输入文章URL:", placeholder="")
